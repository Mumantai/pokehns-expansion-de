...
const u8 gText_LButtonRButton[] = _("L Knopf  R Knopf"); // Unused
const u8 gText_Controls[] = _("STEUERUNG"); // Unused
...
const u8 gText_ThisIsAPokemon[] = _("Das ist ein sogenanntes “POKéMON.”{PAUSE 96}\p");
...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [POCKET_TM_HM]  =       COMPOUND_STRING("TM/VM"),
    [POCKET_BERRIES] =      COMPOUND_STRING("BEEREN"),
    [POCKET_KEY_ITEMS] =    COMPOUND_STRING("BASIS-ITEM"),
...
const u8 gText_InBagVar1[] = _("BEUTEL: {STR_VAR_1}");
...
const u8 gText_NoDecorationHere[] = _("Es gibt keine Dekoration.");
...
const u8 gText_3F[] = _("2F");
const u8 gText_4F[] = _("3F");
const u8 gText_5F[] = _("4F");
const u8 gText_6F[] = _("5F");
const u8 gText_7F[] = _("6F");
const u8 gText_8F[] = _("7F");
const u8 gText_9F[] = _("8F");
const u8 gText_10F[] = _("9F");
const u8 gText_11F[] = _("10F");
...
const u8 gText_ElevatorNowOn[] = _("Aktuell:");
...
const u8 gText_DexNational[] = _("NATIONALEN");
...
const u8 gText_Obtained999RareCandies[] = _("Du erhälst 999 SONDER-\nBONBONS!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_LoveBall[] =     _("SYMPA    / PIRSIF  / (FRY/PSY)");
const u8 gText_Lure[] =         _("KÖDER    / FRAGIA  / (WSR/DRA)");
const u8 gText_FriendBall[] =   _("FREUNDES / AMRENA  / (KFR/PFL)");
const u8 gText_Heavy[] =        _("SCHWER   / SINEL   / (GST/BDN/STL)");
const u8 gText_Moon[] =         _("MOND    / MARON / (UNL/GEI/GIF)");
const u8 gText_Fast[] =         _("TURBO    / WILBIR / (ELK/KMF/FEU)");
const u8 gText_LevelBall[] =    _("LEVEL  / PERSIM / (NRM/FLG/EIS)");
const u8 gText_Vermilion[] = _("ORANIA");
const u8 gText_Olivine[] = _("OLIVIANA");
