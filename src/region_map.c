...
static const struct RegionMapLocation sRegionMapEntries_Johto[] = {
    ...
    [MAPSEC_VICTORY_ROAD_HNS]  = { 16, 4,  1, 4, COMPOUND_STRING("SIEGESSTRASSE") },
    ...
    [MAPSEC_DIGLETTS_CAVE]     = { 20, 3,  6, 4, COMPOUND_STRING("DIGDA-HÖHLE") },
    ...
    [MAPSEC_SNOWSWEPT_CAVERN]  = { 14, 6,  1, 1, COMPOUND_STRING("SCHNEEWEHENHÖHLE") },
    ...
    [MAPSEC_ALOLA_OCEAN]      = { 25, 12, 1, 1, COMPOUND_STRING("MEER VON ALOLA") },
